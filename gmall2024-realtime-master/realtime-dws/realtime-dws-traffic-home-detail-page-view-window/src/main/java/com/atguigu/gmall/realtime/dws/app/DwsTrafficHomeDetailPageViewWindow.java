...
/**
 * @author shichunjian
 * @create date 2024-11-23 16:41
 * @Description：首页、详情页独立访客聚合统计
 *
 * 1）启动zk、kafka、HDFS、flume（f1.sh start）、Doris
 * 2）运行DwdBaseLog、DwsTrafficHomeDetailPageViewWindow
 */
public class DwsTrafficHomeDetailPageViewWindow extends BaseApp {
    public static void main(String[] args) throws Exception{
        new DwsTrafficHomeDetailPageViewWindow().start(
                10023,
                4,
                Constant.DWS_TRAFFIC_H_D_P_V_W,
    ...
    public void handle(StreamExecutionEnvironment env, DataStreamSource<String> kafkaStrDS) {
        ...
        SingleOutputStreamOperator<JSONObject> withWatermarksDS = filterDS.assignTimestampsAndWatermarks(
                WatermarkStrategy
        ...
        KeyedStream<JSONObject, String> keyedDS
                = withWatermarksDS.keyBy(jsonObj -> jsonObj.getJSONObject("common").getString("mid"));
        ...
        reduceDS
                ...
                .sinkTo(FlinkSinkUtil.getDorisSink(Constant.DWS_TRAFFIC_H_D_P_V_W));
    }
}

...
/**
 * @author shichunjian
 * @create date 2024-11-24 10:37
 * @Description：用户域用户注册各窗口汇总表
 * 需要启动的进程：
 * 1）启动zk、kafka、HDFS、Maxwell、Doris
...
public class DwsUserUserRegisterWindow extends BaseApp {
    public static void main(String[] args) throws Exception {
        new DwsUserUserRegisterWindow().start(
                10025,4, Constant.DWS_U_U_R_W,Constant.TOPIC_DWD_USER_REGISTER
        );
    }
    @Override
    public void handle(StreamExecutionEnvironment env, DataStreamSource<String> stream) {
        stream
                ...
                .sinkTo(FlinkSinkUtil.getDorisSink(Constant.DWS_U_U_R_W));

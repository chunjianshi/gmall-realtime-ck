package com.atguigu.gmall.realtime.dwd.db.split.app.function;
...
/**
 * @author shichunjian
 * @create date 2024-11-12 13:20
 * @Description：事实表动态分流函数---处理关联后的数据的函数
 */
public class BaseDbTableProcessFunction extends BroadcastProcessFunction<JSONObject, TableProcessDwd, Tuple2<JSONObject, TableProcessDwd>> {
    ...
    public void open(Configuration parameters) throws Exception {
        ...
        List<TableProcessDwd> tableProcessDwdList
                = JdbcUtil.queryList(mySQLConnection, "select * from gmall_config.table_process_dwd", TableProcessDwd.class, true);

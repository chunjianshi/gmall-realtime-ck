...
import org.apache.hadoop.conf.Configuration;  // 使用Hadoop的Configuration
...
public class HBaseUtil {
    ...
    public static Connection getHBaseConnection() throws IOException {
        ...
        conf.set("hbase.zookeeper.quorum", "bigdata.sbx.com");
        conf.set("zookeeper.znode.parent", "/hbase-unsecure"); // 修改为 /hbase-unsecure
    ...
    public static void createHBaseTable(Connection hbaseConn, String namespace, String tableName, String... families) {
        ...
        try (Admin admin = hbaseConn.getAdmin()) {
            ...
            for (String family : families) {
                ...
                //System.out.println("输出family    " + family );
            }
    ...
    */
    ...
    public static void main(String[] args) throws Exception {
        ...
        JSONObject jsonObj = getRow(hBaseConnection, Constant.HBASE_NAMESPACE, Constant.HBASE_DIMTABLE_TRADEMARK, "1", JSONObject.class);
